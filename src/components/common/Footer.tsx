...
const Footer = () => (
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto pl-4 pr-4  sm:pl-0 sm:pr-0">
    <div className="container grid grid-cols-1 gap-1 lg:grid-cols-2 lg::gap-2">
